...
lastName = "Guevara";
age = "25";
console.log(`Soy ${firstName} ${lastName}, tengo ${age} años y me gusta la programación`);
...
//25000 y actualiza la propiedad finalPrice de todos los coches con el valor de su
//propiedad basePrice más el valor de la variable globalBasePrice.
